...
```
I was able to obtain to top 3 most rated locations by using the table() function to count the occurences of each location in the table and then sort them in decreasing order. Then I index the first 3. To find how to ratings among the 3 locations compare, I took the mean rating of all ratings for each location using the mean() function.

### Interesting question: plot Rating vs. Company with color for differnt companies
```{r}
...
```
For our question, we found the company with the most frequent 
